...
const Lobby = () => {
    ...
    //this might complicate things and is probably unnecessary for m3
    const handleUserClick = (id) => {
        // redirect to user profile (IF user is registered)
        // somehow maintain WS connection though?
        // maybe make profile info a dialog instead of a new page?
    }
