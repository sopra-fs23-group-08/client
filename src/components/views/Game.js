    ...
    useEffect(() => {
     ...
     //Subscribe to the video
          const videoSubscription = client.subscribe(
            ...
            connectSocket();
          }, [connect, location.pathname, handlePlayerListUpdate, handleCurrentPlayer, handleCommentsUpdate, handleVideoDataUpdate, handleGameUpdate, handleDecisionSubmit, handleLeaveGame, history, token]);
